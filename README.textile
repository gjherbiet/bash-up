...
* If *you used a non-default directory* to download _bash-up_, you need to *edit the* @BU DIRECTORY@ *variable* in both _bash-up_'s @.profile@ and _bash-up_'s @.bashrc@ files.
